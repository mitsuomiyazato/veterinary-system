...
public class Principal {
	...
	private void initialize() {
		...
		textAreaHistoricoObservacoes.setBounds(394, 44, 409, 110);
		panelHistoricoPacienteSelecionado.add(textAreaHistoricoObservacoes);
		...
		scrollPaneTableVeterinario.setBounds(9, 51, 789, 155);
		...
		JButton btnAgendamentoEditar = new JButton("Editar");
		btnAgendamentoEditar.setBounds(10, 157, 149, 23);
		panelAgendamentosExistentes.add(btnAgendamentoEditar);
		...
		textAreaObservacoesReceita.setBounds(10, 111, 788, 120);
		panelSelecionarInfo.add(textAreaObservacoesReceita);
		...
		tableReceita.setModel(new DefaultTableModel(
				...
				new String[] {
					"Cliente", "Paciente", "Veterin\u00E1rio", "Data"
				}
			));
		JScrollPane scrollPaneTableReceita = new JScrollPane(tableReceita);
		scrollPaneTableVeterinario.setBounds(10, 22, 788, 115);
		panelBuscarReceita.add(scrollPaneTableReceita);  
				...
				JPanel GroupBoxCliente_1 = new JPanel();
				GroupBoxCliente_1.setLayout(null);
				GroupBoxCliente_1.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Faturas", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
				GroupBoxCliente_1.setBounds(10, 11, 808, 430);
				TabbedPanelEstoque.add(GroupBoxCliente_1);
				
				JLabel lblBuscarCliente_1 = new JLabel("Buscar:");
				lblBuscarCliente_1.setBounds(10, 26, 46, 14);
				GroupBoxCliente_1.add(lblBuscarCliente_1);
				
				textField_3 = new JTextField();
				textField_3.setColumns(10);
				textField_3.setBounds(66, 23, 228, 20);
				GroupBoxCliente_1.add(textField_3);
				
				JButton btnTodosCliente_1 = new JButton("Todos");
				btnTodosCliente_1.setBounds(304, 22, 77, 23);
				GroupBoxCliente_1.add(btnTodosCliente_1);
				
				JButton btnNovaFatura = new JButton("Nova fatura");
				btnNovaFatura.setBounds(391, 22, 135, 23);
				GroupBoxCliente_1.add(btnNovaFatura);
				
				JButton btnApagarFatura = new JButton("Apagar Fatura");
				btnApagarFatura.setBounds(536, 22, 131, 23);
				GroupBoxCliente_1.add(btnApagarFatura);
				
				JButton btnEditarFatura = new JButton("Editar Fatura");
				btnEditarFatura.setBounds(677, 22, 121, 23);
				GroupBoxCliente_1.add(btnEditarFatura);
				
				JScrollPane scrollPaneTableCliente_1 = new JScrollPane((Component) null);
				scrollPaneTableCliente_1.setBounds(10, 51, 788, 368);
				GroupBoxCliente_1.add(scrollPaneTableCliente_1);
	}
